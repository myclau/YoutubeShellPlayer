...
. "$YoutubeShellPlayerScriptPath\Lib\VideoDownloader\VideoDownloader.ps1"
. "$YoutubeShellPlayerScriptPath\Lib\VideoPlayer\VideoPlayer.ps1"
$DownLoadPath = "$YoutubeShellPlayerScriptPath\YouTubeVideoCache"
...
VideoPlayer "$videoLocation" "DeleteCache"
} else {
